  ...
  public function execute() {
    try {
      if (request::getInstance()->hasRequest(usuarioTableClass::ID)) {
        ...
        $where = array(
            localidadTableClass::ID => request::getInstance()->getRequest(localidadTableClass::ID)
        );
        $this->objUsuarios = localidadTableClass::getAll($fields, true, null, null, null, null, $where);
