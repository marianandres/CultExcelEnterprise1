            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('categoria', 'index') ?>' class="active"><i class='icon-home-3'></i><span><?php echo i18n::__('Categoria') ?></span> <span class="pull-right"></span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class="fa fa-cc"></i> Categorias  <?php i18n::__('userCredencial') ?></h1>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <div class="widget-header">
                                <h2><strong> <?php i18n::__('Categorias') ?>  <?php i18n::__('userCredencial') ?></strong></h2>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" role="form" id="filterForm" action="<?php echo routing::getInstance()->getUrlWeb('categoria', 'index') ?>">
                                                <div class="form-group">
                                                    <label for="filterusuario" class="col-sm-2 control-label"><?php i18n::__('usuario') ?>Usuario</label>
                                                    <div class="col-sm-10">
                                ...
                                <div class="table-responsive">
                                    <form id="frmDeleteAll" class='form-horizontal' action="<?php echo routing::getInstance()->getUrlWeb('categoria', 'deleteSelect') ?>" method="POST">
                                        <div  style="margin-bottom: 10px; margin-top: 20px;">
                                            <a href="<?php echo routing::getInstance()->getUrlWeb('categoria', 'insert') ?>" class="btn btn-success btn-medium"><i class="fa fa-plus-square-o"></i> <?php echo i18n::__('Nuevo') ?></a>
                                            <a href="#" class="btn btn-danger btn-medium" onclick="borrarSeleccion()"><?php echo i18n::__('Borrar') ?></a>
                                            <a href="<?php echo routing::getInstance()->getUrlWeb('categoria', 'report') ?>" class="btn btn-default btn-medium"><i class="fa fa-file-pdf-o"></i><?php echo i18n::__('ExporPDF') ?></a>
                                            ...
                                            <a class="btn btn-default btn-medium" href="<?php echo routing::getInstance()->getUrlWeb('categoria', 'deleteFilters') ?>"><i class="fa fa-minus-circle"></i> <?php echo i18n::__('EliminarFiltros') ?></a>
                                        </div>
