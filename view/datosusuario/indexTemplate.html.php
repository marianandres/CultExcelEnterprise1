...
<?php view::includePartial('datosUsuario/datoUsuarioModalWindows') ?>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class="fa fa-database"></i> <?php echo i18n::__('DatoUsu') ?> </h1>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <div class="widget-header">
                                <h2><strong><?php echo i18n::__('DatosUsuSis') ?></strong></h2>
                                ...
                                <div class="table-responsive">
                                    <form id="frmDeleteAll" class='form-horizontal' action="<?php echo routing::getInstance()->getUrlWeb('datosusuario', 'deleteSelect') ?>" method="POST">
                                        <div  style="margin-bottom: 10px; margin-left: 10px; margin-top: 20px;">
                                            <button type="button" class="btn  btn-success btn-medium" data-toggle="modal" data-target="#newUserData" ><i class="fa fa-plus-square-o"></i> <?php echo i18n::__('Nuevo') ?> </button>
