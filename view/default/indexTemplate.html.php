                ...
                <div class="row">
                    <div class="col-md-7">
                        ...
                        <div class="contact-details">
                            <a href="#"><i class="fa fa-map-marker"></i><?php echo i18n::__('lugar') ?></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <!-- Text -->
                    <p class="text-center"><?php echo i18n::__('Sed') ?></p>
                </div>
            </div>
            ...
            <div class="row pricing-tables">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="pricing-table">
                        ...
                        <div class="plan-price">
                            ...
                            <div class="interval"><?php echo i18n::__('$49') ?>per month</div>
                        </div>
                        <div class="plan-list">
                            <ul>
                        ...
                        <div class="plan-signup">
                            <a href="#" class="btn-system btn-small"><?php echo i18n::__('Sign Up Now') ?></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12">
                    <div class="pricing-table">
                        ...
                        <div class="plan-price">
                            <div class="price-value"><?php echo i18n::__('$199') ?><span><?php echo i18n::__('P.00') ?></span></div>
                            <div class="interval"><?php echo i18n::__('per') ?></div>
                        </div>
                        <div class="plan-list">
                            <ul>
    ...
    <div class="partner">
        <div class="container">
            <div class="row">
                ...
                <!-- Start Big Heading -->
                <div class="big-title text-center">
                    <h1><?php echo i18n::__('Our Happy') ?> <strong><?php echo i18n::__('Clients') ?></strong></h1>
