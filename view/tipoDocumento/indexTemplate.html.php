        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class="fa fa-file-text-o"></i>   <?php i18n::__('tipoDocumento') ?></h1>
                    <h3><?php i18n::__('TipoDocumentoSistem') ?></h3>            	</div>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <div class="widget-header">
                                <h2><strong>   <?php i18n::__('tipoDocumento') ?></strong></h2>
                                ...
                                <div class="table-responsive">
                                    <form id="frmDeleteAll" class='form-horizontal' action="<?php echo routing::getInstance()->getUrlWeb('tipoDocumento', 'deleteSelect') ?>" method="POST">
                                        <div  style="margin-bottom: 10px; margin-top: 20px;">
                                            <a href="<?php echo routing::getInstance()->getUrlWeb('tipoDocumento', 'insert') ?>" class="btn btn-success btn-medium"><i class="fa fa-plus-square-o"></i> <?php i18n::__('Nuevo') ?></a>
                                        ...
                                        <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th><input type="checkbox" id="chkAll"></th>
                                                    <th> <?php i18n::__('tipodocumento') ?></th>
                                                    <th><?php echo i18n::__('fechaCreacion') ?></th>
                                                    <th><?php echo i18n::__('actions') ?></th>
                                                </tr>
                                            </tfoot>
                                                ...
                                                <?php foreach ($objTipoDocumento as $usuario): ?>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          ...
                                                          <a href="<?php echo routing::getInstance()->getUrlWeb('tipoDocumento', 'edit', array(tipoDocumentoTableClass::ID => $usuario->$id)) ?>" class="btn btn-primary btn-xs"><?php i18n::__('Editar') ?></a>
