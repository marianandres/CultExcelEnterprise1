            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('credencial', 'index') ?>' class="active"><i class="fa fa-user"></i><span><?php echo i18n::__('Credenciales') ?></span> <span class="pull-right"></span></a></li>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                <br>					
                                <?php view::includeHandlerMessage() ?>
                                <?php view::includePartial('credencial/formUser', array('mensaje' => $mensaje)) ?> 
                            </div>
                        </div>
                    </div>
                </div>
