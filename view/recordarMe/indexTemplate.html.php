            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('recordarMe', 'index') ?>' class="active"><i class="fa fa-bookmark"></i><span>Recordar Me</span> <span class="pull-right"></span></a></li>
