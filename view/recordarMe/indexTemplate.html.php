...
<?php $usu = recordarMeTableClass::USUARIO_ID ?>
<?php $id = recordarMeTableClass::ID ?>
<?php $ip = recordarMeTableClass::IP_ADDRESS ?>
<?php $hash_cookie = recordarMeTableClass::HASH_COOKIE ?>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class="fa fa-bookmark"></i>  <?php echo i18n::__('RecordarMe') ?></h1>
                    <h3><?php echo i18n::__('RecordarMeSistema') ?></h3>            	</div>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <div class="widget-header">
                                <h2><strong>  <?php echo i18n::__('RecordarMeSistema') ?></strong></h2>
...
<!--                                            <a href="<?php echo routing::getInstance()->getUrlWeb('recordarMe', 'report') ?>" class="btn btn-default btn-medium"><i class="fa fa-file-pdf-o"></i><?php i18n::__('ExporPDF') ?> </a>
                                        ...
                                        <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo i18n::__('IPAddress') ?></th>
                                                    <th> <?php echo i18n::__('HashCookie') ?></th>
                                            ...
                                            <tbody>
                                                <?php foreach ($objRecordarMe as $usuario): ?>
                                                    <tr>
    ...
    <!--                                                          <a href="<?php echo routing::getInstance()->getUrlWeb('usuario', 'edit', array(recordarMeTableClass::ID => $usuario->$id)) ?>" class="btn btn-primary btn-xs<?php echo i18n::__('Editar') ?>"</a>-->
                                                            <a href="#" onclick="confirmarEliminar(<?php echo $usuario->$id ?>)" class="btn btn-danger btn-xs"><?php echo i18n::__('Eliminar') ?></a>
    <!--                                                          <a href="<?php echo routing::getInstance()->getUrlWeb('usuarioCredencial', 'index', array(recordarMeTableClass::getNameField(recordarMeTableClass::USUARIO_ID, true) => $usuario->$id)) ?>" class="btn btn-success btn-xs"><i class="fa fa-external-link-square"></i><?php echo i18n::__('Detalles') ?> </a>-->
