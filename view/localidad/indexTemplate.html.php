            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('localidad', 'index') ?>' class="active" ><i class="fa fa-building"></i><span>Localidad</span> <span class="pull-right"></span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class="fa fa-building"></i>  <?php i18n::__('Localidad') ?></h1>
                    <h3><?php i18n::__('EventosSistema') ?></h3>            	</div>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <div class="widget-header">
                                <h2><strong><?php i18n::__('evento') ?></strong></h2>
                            ...
                            <div class="modal fade" id="myModalfilter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" role="form" id="filterForm" action="<?php echo routing::getInstance()->getUrlWeb('localidad', 'index') ?>">
                                                <div class="form-group">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-default" data-dismiss="modal"><?php i18n::__('FechaCreacion') ?>Cerrar</button>
                                            <button type="button" onclick="$('#filterForm').submit()"  class="btn btn-primary"><?php i18n::__('FechaCreacion') ?>Filtrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="widget-content">
                                ...
                                <div class="table-responsive">
                                    <form id="frmDeleteAll" class='form-horizontal' action="<?php echo routing::getInstance()->getUrlWeb('localidad', 'deleteSelect') ?>" method="POST">
                                        <div  style="margin-bottom: 10px; margin-top: 20px;">
                                            <a href="<?php echo routing::getInstance()->getUrlWeb('localidad', 'insert') ?>" class="btn btn-success btn-medium"><i class="fa fa-plus-square-o"></i><?php i18n::__('Nuevo') ?> </a>
                                            <a href="#" class="btn btn-danger btn-medium" onclick="borrarSeleccion()"><?php i18n::__('Borrar') ?></a>
                                            <a href="<?php echo routing::getInstance()->getUrlWeb('localidad', 'report') ?>" class="btn btn-default btn-medium"><i class="fa fa-file-pdf-o"></i><?php i18n::__('ExporPDF') ?> </a>
                                            ...
                                            <a class="btn btn-default btn-medium" href="<?php echo routing::getInstance()->getUrlWeb('localidad', 'deleteFilters') ?>"><i class="fa fa-minus-circle"></i><?php i18n::__('EliminarFiltros') ?> </a>
                                        </div>
                                        <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" id="chkAll"></th>
                                                    <th> <?php i18n::__('Nom') ?></th>
                                                    <th><?php i18n::__('LocalidadID') ?></th>
                                            ...
                                            <tbody>
                                                <?php foreach ($objLocalidad as $usuario): ?>
                                                  <tr>
                                                      <td><input type="checkbox" name="chk[]" value="<?php echo $usuario->$id ?>"></td>
                                                      <td><?php echo $usuario->$nombre ?></td>
                                                      <td><?php echo $usuario->$localidad_id ?></td>
                                                      <td>
                                                          <!--                    <a href="#" class="btn btn-warning btn-xs">Ver</a>-->
                                                          <a href="<?php echo routing::getInstance()->getUrlWeb('localidad', 'edit', array(localidadTableClass::ID => $usuario->$id)) ?>" class="btn btn-primary btn-xs"><?php echo i18n::__('Editar') ?></a>
