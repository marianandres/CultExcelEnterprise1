...
<!--                                           <button type="button" class="btn  btn-success btn-medium" data-toggle="modal" data-target="#newLocalidad" ><i class="fa fa-plus-square-o"></i> <?php echo i18n::__('Nuevo') ?> </button>-->
