            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('datosusuario', 'index') ?>' ><i class="fa fa-database"></i><span><?php echo i18n::__('Datos') ?></span> <span class="pull-right"></span></a></li>
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('usuarioCredencial', 'index') ?>' class="active"><i class='icon-home-3'></i><span>Usuario Credencial</span> <span class="pull-right"></span></a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    <h1><i class="fa fa-cc"></i>  <?php echo i18n::__('userCredencial') ?></h1>
                    <h3>Credenciales De Usuarios Del Sistema</h3>            	</div>
                    ...
                    <div class="col-md-12">
                        <div class="widget">
                            <div class="widget-header">
                                <h2><strong><?php echo i18n::__('userCredencial') ?></strong></h2>
                            ...
                            <div class="modal fade" id="myModalfilter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" role="form" id="filterForm" action="<?php echo routing::getInstance()->getUrlWeb('usuarioCredencial', 'index') ?>">
                                                <div class="form-group">
                                ...
                                <div class="table-responsive">
                                    <form id="frmDeleteAll" class='form-horizontal' action="<?php echo routing::getInstance()->getUrlWeb('usuarioCredencial', 'deleteSelect') ?>" method="POST">
                                        <div  style="margin-bottom: 10px; margin-top: 20px;">
                                            <a href="<?php echo routing::getInstance()->getUrlWeb('usuarioCredencial', 'insert') ?>" class="btn btn-success btn-medium"><i class="fa fa-plus-square-o"></i> Nuevo</a>
                                            <a href="#" class="btn btn-danger btn-medium" onclick="borrarSeleccion()">Borrar</a>
                                            <a href="<?php echo routing::getInstance()->getUrlWeb('usuarioCredencial', 'report') ?>" class="btn btn-default btn-medium"><i class="fa fa-file-pdf-o"></i> Exportar A PDF</a>
                                            ...
                                            <a class="btn btn-default btn-medium" href="<?php echo routing::getInstance()->getUrlWeb('usuarioCredencial', 'deleteFilters') ?>"><i class="fa fa-minus-circle"></i> Eliminar Filtros</a>
                                        </div>
                                        <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th><input type="checkbox" id="chkAll"></th>
                                                    <th>Credencial <?php i18n::__('usuario') ?></th>
                                            ...
                                            <tbody>
                                                <?php foreach ($objUsuarioCredencial as $usuario): ?>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <a href="<?php echo routing::getInstance()->getUrlWeb('usuarioCredencial', 'edit', array(usuarioCredencialTableClass::ID => $usuario->$id)) ?>" class="btn btn-primary btn-xs">Editar</a>
                                    ...
                                    <div>
                                        <a class="btn btn-success btn-medium" href="<?php echo routing::getInstance()->getUrlWeb('usuario', 'index') ?>"><i class="fa fa-arrow-circle-left"></i> Regresar</a> 
                                    </div>
