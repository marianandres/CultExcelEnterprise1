        ...
        <div class="content-page">
            ...
            <div class="content">
                ...
                <div class="page-heading">
                    ...
                    <h3><?php echo i18n::__('CredenUsuSistema') ?></h3>            	</div>
                        ...
                        <div class="widget">
                            ...
                            <div class="widget-content">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div>
                                        <a class="btn btn-success btn-medium" href="<?php echo routing::getInstance()->getUrlWeb('usuario', 'index') ?>"><i class="fa fa-arrow-circle-left"></i><?php i18n::__('Regresar') ?> </a> 
                                    </div>
