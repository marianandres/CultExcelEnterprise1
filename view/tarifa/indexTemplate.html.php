            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('tarifa', 'index') ?>' class="active"><i class='icon-home-3'></i><span>Tarifa</span> <span class="pull-right"></span></a></li>
                                ...
                                <div class="table-responsive">
                                    <form id="frmDeleteAll" class='form-horizontal' action="<?php echo routing::getInstance()->getUrlWeb('tarifa', 'deleteSelect') ?>" method="POST">
                                        ...
                                        <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                                <?php foreach ($objTarifa as $usuario): ?>
                                                  <tr>
