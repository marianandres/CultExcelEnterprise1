            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('bitacora', 'index') ?>' class="active"><i class="fa fa-edit fa-fw"></i><span>Bitacora</span> <span class="pull-right"></span></a></li>
