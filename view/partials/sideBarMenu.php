...
<!--                    <li class='has_sub'>
                    ...
                    <li class='has_sub'>
                            ...
                            <ul>
                                <li><a href='<?php echo routing::getInstance()->getUrlWeb('pqrs', 'index') ?>' <?php echo (session::getInstance()->hasFlash('pqrs') ? 'class="active"' : '') ?>><i class='icon-home-3'></i><span>Admin. De <?php echo i18n::__('PQRS') ?>´S</span> <span class="pull-right"></span></a></li>
...
<!--                                <li><a href='<?php echo routing::getInstance()->getUrlWeb('estadoPqrs', 'index') ?>' <?php echo (session::getInstance()->hasFlash('estadoPqrs') ? 'class="active"' : '') ?>><i class='icon-home-3'></i><span><?php echo i18n::__('Estado') ?></span> <span class="pull-right"></span></a></li>-->
                    ...
                    <li class='has_sub'>
                        <a href='javascript:void(0);'><i class='fa fa-hdd-o'></i><span> Admin De Publicacion De Eventos </span> <span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                        <ul>
                            <li><a href='<?php echo routing::getInstance()->getUrlWeb('evento', 'index') ?>' <?php echo (session::getInstance()->hasFlash('evento') ? 'class="active"' : '') ?>><i class="fa fa-calendar"></i><span> Administracion De Eventos</span> <span class="pull-right"></span></a></li>
                            <li><a href='<?php echo routing::getInstance()->getUrlWeb('categoria', 'index') ?>' ><i class='fa fa-check-square-o'></i><span><?php echo i18n::__('Categoria') ?> De Eventos</span> <span class="pull-right"></span></a></li>
                        </ul>
                    </li>
