...
$pdf->SetTitle('Reporte de Eventos Publicados Por Categoria');
$pdf->SetSubject('Reporte General De Eventos Publicados Por Categoria En el Sistema');
$pdf->SetKeywords('Reporte, Eventos, Categorias, Sistema ');
...
//</body>
//</html>');
$pdf->Output('Reporte General De Eventos Publicados Por Categoria.pdf', 'I');
?>