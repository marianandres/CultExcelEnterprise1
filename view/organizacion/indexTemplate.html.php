...
<?php view::includePartial('organizacion/organizacionModalWindows') ?>
                                ...
                                <div class="table-responsive">
                                    <form id="frmDeleteAll" class='form-horizontal' action="<?php echo routing::getInstance()->getUrlWeb('organizacion', 'deleteSelect') ?>" method="POST">
                                        <div  style="margin-bottom: 10px; margin-left: 10px; margin-top: 20px;">
                                            <button type="button" class="btn  btn-success btn-medium" data-toggle="modal" data-target="#newOrganization" ><i class="fa fa-plus-square-o"></i> <?php echo i18n::__('Nuevo') ?> </button>
                                        ...
                                        <table id="datatables-1" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th><?php echo i18n::__('PaginaWeb') ?></th>
                                                ...
                                                <?php foreach ($objOrganizacion as $usuario): ?>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          ...
                                                          <a href="<?php echo routing::getInstance()->getUrlWeb('organizacion', 'edit', array(organizacionTableClass::ID => $usuario->$id)) ?>" class="btn btn-primary btn-xs"><?php echo i18n::__('Editar') ?></a>
