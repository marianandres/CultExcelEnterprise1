            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li><a href='<?php echo \mvc\routing\routingClass::getInstance()->getUrlWeb('usuario', 'index') ?>' class="active"><i class="fa fa-users fa-fw"></i><span><?php echo i18n::__('adminusuario') ?></span> <span class="pull-right"></span></a></li>
