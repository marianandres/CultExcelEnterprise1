                ...
                <div id="collapseOne" class="panel-collapse collapse in">
                    <div class="panel-body">
                        <table class="table">
                            ...
                            <tr>
                                <td>
                                    <a class="btn btn-default btn-medium" href="<?php echo routing::getInstance()->getUrlWeb('userEvents', 'deleteFilters') ?>"><i class="fa fa-minus-circle"></i> <?php echo i18n::__('EliminarFiltros') ?></a>
                                </td>
                            </tr>
                        </table>
                    </div>
    ...
    <div class="section service">
        <div class="container">
            <div class="row">
                ...
                <!--                                <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>-->
                                                <center>
                                                    <strong></strong><i class="fa fa-calendar-o fa-5x"></i><h3>No Tiene Eventos Publicados Pasados!.</h3> 
                                                    <?php if (usuarioTableClass::getVerifyUser(mvc\session\sessionClass::getInstance()->getUserId()) == 1) { ?>
                                                        Desea <a href="<?php echo routing::getInstance()->getUrlWeb('eventos', 'insert') ?>"><i class="fa fa-link"></i> Crear Evento</a>
                                                    <?php } ?>
                                                </center>
                    ...
                    <div class="col-sm-12">
                        <br>
                        <a href="<?php echo routing::getInstance()->getUrlWeb('usuario', 'report') ?>" class="btn btn-danger btn-medium"><i class="fa fa-file-pdf-o"></i> Exportar En Formato PDF</a>    
                    </div>
                </div>
            </div>
        </div><!-- .container -->
