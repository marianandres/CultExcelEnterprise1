    ...
    w === b && (w = exports, x = c("./tree"), w.mode = "node"), w.Parser = function (a) {
                ...
                return a.processImports === !1 ? p() : void new x.importVisitor(this.imports, p).run(g)
                    ...
                    if ("." !== l && "#" !== l && "&" !== l)
                        if (d(), c = this.variable() || this.ruleProperty()) {
                            if (j = "string" == typeof c, j && (g = this.detachedRuleset()), this.comments(), g || (g = b || !a.compress && !j ? this.anonymousValue() || this.value() : this.value() || this.anonymousValue(), h = this.important(), i = !j && c.pop().value), g && this.end())
                    ...
                    if (e) {
                        ...
                        if (b = this.entities.quoted() || this.entities.url())
                            return c = this.mediaFeatures(), i(";") || (y = d, o("missing semi-colon or unrecognised media features on import")), c = c && new x.Value(c), new x.Import(b, c, f, d, a.currentFileInfo);
        ...
        d.functions = {rgb: function (a, b, c) {
                ...
                if (r >= q && this.env.ieCompat !== !1)
                    return this.env.silent || console.warn("Skipped data-uri embedding of %s because its size (%dKB) exceeds IE8-safe %dKB!", g, r, q), new d.URL(e || b, this.currentFileInfo).eval(this.env);
        ...
        a.Ruleset = function (a, b, c) {
            this.selectors = a, this.rules = b, this._lookups = {}, this.strictImports = c
                ...
                if (l = k.concat(l), !this.root) {
                    ...
                    for (n = b.compress?",":",\n" + p, e = 0; s > e; e++)
                        if (j = r[e], q = j.length)
                            for (e > 0 && c.add(n), b.firstSelector = !0, j[0].genCSS(b, c), b.firstSelector = !1, f = 1; q > f; f++)
                                j[f].genCSS(b, c);
                    c.add((b.compress ? "{" : " {\n") + o)
                }
                ...
                if (this.root || (c.add(b.compress ? "}" : "\n" + p + "}"), b.tabLevel--), n = (b.compress ? "" : "\n") + (this.root ? o : p), g = m.length)
                    for (l.length && n && c.add(n), m[0].genCSS(b, c), e = 1; g > e; e++)
