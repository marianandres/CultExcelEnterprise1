...
(function (q) {
    var r = function (d) {
        var k = function (a, b) {
            ...
            if (!this instanceof k)
                ...
                this.dom = {scroller: null, header: null, body: null, footer: null,
            ...
            fnRecalculateHeight: function (a) {
                ...
                if ("function" != typeof this.s.dt.oInstance.fnVersionCheck || !0 !== this.s.dt.oInstance.fnVersionCheck("1.8.0"))
                    ...
                    if (0 <
                        ...
                        }).on("wheel.DTFC", function (a) {
                            b.dom.scroller.scrollLeft -= -a.originalEvent.deltaX
                        });
                    if (0 < b.s.iRightColumns)
                        d(b.dom.grid.right.liner).on("mouseover.DTFC touchstart.DTFC", function () {
                            ...
                            "right" ===
                                    c && (b.dom.scroller.scrollTop = b.dom.grid.right.liner.scrollTop, 0 < b.s.iLeftColumns && (b.dom.grid.left.liner.scrollTop = b.dom.grid.right.liner.scrollTop))
                        }).on("wheel.DTFC", function (a) {
                            b.dom.scroller.scrollLeft -= -a.originalEvent.deltaX
                        });
                    ...
                    f.on("draw.dt.DTFC", function () {
                        ...
                        f.off("column-sizing.dt.DTFC destroy.dt.DTFC draw.dt.DTFC");
                        d(b.dom.scroller).off("scroll.DTFC mouseover.DTFC");
                        d(q).off("resize.DTFC");
                        d(b.dom.grid.left.liner).off("scroll.DTFC wheel.DTFC mouseover.DTFC");
                        d(b.dom.grid.left.wrapper).remove();
                        d(b.dom.grid.right.liner).off("scroll.DTFC wheel.DTFC mouseover.DTFC");
                ...
                d.each(this.s.dt.aoColumns, function (g, f) {
                    ...
                    if (e.filter(":visible").length) {
                        ...
                        if (0 === a.s.aiOuterWidths.length)
                            var j = d(a.s.dt.nTable).css("border-left-width"), h = h + ("string" === typeof j ? 1 : parseInt(j, 10));
                        a.s.aiOuterWidths.push(h);
                        a.s.aiInnerWidths.push(e.width());
                        g < a.s.iLeftColumns && (b += h);
                        a.s.iTableColumns - a.s.iRightColumns <= g && (c += h)
                    } else
                ...
                var a =
                        this.dom.grid, b = d(a.wrapper).width(), c = d(this.s.dt.nTable.parentNode).height(), g = d(this.s.dt.nTable.parentNode.parentNode).height(), f = this._fnDTOverflow(), e = this.s.iLeftWidth, h = this.s.iRightWidth;
                f.x && (c -= f.bar);
                ...
                0 < this.s.iRightColumns &&
                        (b -= h, f.y && (b -= f.bar), a.right.wrapper.style.width = h + "px", a.right.wrapper.style.left = b + "px", a.right.wrapper.style.height = "1px", a.right.body.style.height = c + "px", a.right.foot && (a.right.foot.style.top = (f.x ? f.bar : 0) + "px"), a.right.liner.style.width = h + f.bar + "px", a.right.liner.style.height = c + "px", a.right.headBlock.style.display = f.y ? "block" : "none", a.right.footBlock.style.display = f.y ? "block" : "none")
                ...
                for (var c = [], g = [], f = [], e = 0, h = a.length; e < h; e++) {
                    var j = [];
                    j.nTr = d(a[e].nTr).clone(!0, !0)[0];
                    for (var i = 0, n = this.s.iTableColumns; i < n; i++)
                        if (-1 !== d.inArray(i, b)) {
                            var l = d.inArray(a[e][i].cell, f);
                            -1 === l ? (l =
                                    d(a[e][i].cell).clone(!0, !0)[0], g.push(l), f.push(a[e][i].cell), j.push({cell: l, unique: a[e][i].unique})) : j.push({cell: g[l], unique: a[e][i].unique})
                        }
                    c.push(j)
                }
                return c
            }, _fnClone: function (a, b, c, g) {
                var f = this, e, h, j, i, n, l, k, m, o;
                if (g) {
                    ...
                    for (h = m.length; e < h; e++)
                        i[0].appendChild(m[e].nTr);
                    this.s.dt.oApi._fnDrawHead(this.s.dt, m, !0)
                } else {
                    m = this._fnCopyLayout(this.s.dt.aoHeader, c);
                    o = [];
                    this.s.dt.oApi._fnDetectHeader(o, d(">thead", a.header)[0]);
                    e = 0;
                    for (h = m.length; e < h; e++) {
                        j = 0;
                        for (i = m[e].length; j < i; j++)
                            o[e][j].cell.className = m[e][j].cell.className, d("span.DataTables_sort_icon", o[e][j].cell).each(function () {
                                this.className = d("span.DataTables_sort_icon", m[e][j].cell)[0].className
                            })
                    }
                }
                ...
                if (0 < this.s.dt.aiDisplay.length) {
                    ...
                    for (k = 0; k < c.length; k++)
                        n = c[k], l = d(this.s.dt.aoColumns[n].nTh).clone(!0)[0], l.innerHTML = "", i = l.style, i.paddingTop = "0", i.paddingBottom = "0", i.borderTopWidth = "0", i.borderBottomWidth = "0", i.height = 0, i.width = f.s.aiInnerWidths[n] + "px", h.appendChild(l);
                ...
                if (null !== this.s.dt.nTFoot) {
                    if (g) {
                        ...
                        for (h = m.length; e < h; e++) {
                            j = 0;
                            for (i = m[e].length; j < i; j++)
                                b[e][j].cell.className = m[e][j].cell.className
                        }
                    }
    ...
    "function" === typeof define && define.amd ? define("datatables-fixedcolumns", ["jquery", "datatables"], r) : jQuery && !jQuery.fn.dataTable.FixedColumns && r(jQuery, jQuery.fn.dataTable)
})(window, document);
