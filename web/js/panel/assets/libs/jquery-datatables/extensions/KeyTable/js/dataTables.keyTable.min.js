...
(function (F, n, K) {
    var D = function (d) {
        KeyTable = function (j) {
            ...
            function L(a) {
                return function (e, c, p) {
                    (null === e || "number" == typeof e) && (null === c || "number" == typeof c) ? "function" == typeof p ? A(a, e, c, p) : A(a, e, c) : "object" ==
                            typeof e ? (e = E(e), "function" == typeof c ? A(a, e[0], e[1], c) : A(a, e[0], e[1])) : alert("Unhandable event type was removed: x" + e + "  y:" + c + "  z:" + p)
                }
            }
            function A(a, e, c, p) {
            ...
            var z = null, t = null, l = null, g = null, J = null, x = "focus", o = !1, k = {action: [], esc: [], focus: [], blur: []}, i = null, C, s, u = !1, m;
            for (m in k)
                m && (this.event[m] = D(m), this.event.remove[m] = L(m));
            var v;
            ...
            C ? (j = n.createElement("div"), s = n.createElement("input"), j.style.height = "1px", j.style.width = "0px", j.style.overflow = "hidden", "undefined" != typeof b.tabIndex &&
    ...
    "function" === typeof define && define.amd ? define("datatables-keytable", ["jquery", "datatables"], D) : jQuery && !jQuery.fn.dataTable.KeyTable && D(jQuery, jQuery.fn.dataTable)
})(window, document);
