...
(function (j, m, k) {
    var l = function (e) {
        ...
        f.prototype = {fnRowToPixels: function (a, b, c) {
                ...
                var c = this,
                        d = !1, g = this.fnRowToPixels(a), f = a - (this.s.displayBuffer - 1) / 2 * this.s.viewportRows;
                0 > f && (f = 0);
                if ((g > this.s.redrawBottom || g < this.s.redrawTop) && this.s.dt._iDisplayStart !== f)
                    d = !0, g = this.fnRowToPixels(a, !1, !0);
                "undefined" == typeof b || b ? (this.s.ani = d, e(this.dom.scroller).animate({scrollTop: g}, function () {
                    setTimeout(function () {
                        c.s.ani = !1
                    }, 0)
                ...
                this.s.viewportRows =
                        parseInt(b.viewport / b.row, 10) + 1;
                ...
                if (!this.s.skip)
                    if (this.s.dt.bFiltered || this.s.dt.bSorted)
                        ...
                        if (c < this.s.redrawTop || c > this.s.redrawBottom) {
                            ...
                            Math.abs(c - this.s.lastScrollTop) > b.viewport || this.s.ani ? (d = parseInt(this._domain("physicalToVirtual", c) / b.row, 10) - g, this.s.topRowFloat = this._domain("physicalToVirtual", c) / b.row) : (d = this.fnPixelsToRow(c) - g, this.s.topRowFloat = this.fnPixelsToRow(c, !1));
                            0 >= d ? d = 0 : d + this.s.dt._iDisplayLength >
                                    this.s.dt.fnRecordsDisplay() ? (d = this.s.dt.fnRecordsDisplay() - this.s.dt._iDisplayLength, 0 > d && (d = 0)) : 0 !== d % 2 && d++;
                            d != this.s.dt._iDisplayStart && (this.s.tableTop = e(this.s.dt.nTable).offset().top, this.s.tableBottom = e(this.s.dt.nTable).height() + this.s.tableTop, b = function () {
                            ...
                            }, this.s.dt.oFeatures.bServerSide ? (clearTimeout(this.s.drawTO), this.s.drawTO =
                                    setTimeout(b, this.s.serverWait)) : b())
                        }
                ...
                for (e("tbody tr:lt(4)", a).clone().appendTo(c); 3 > e("tr", c).length; )
                ...
                if (this.s.dt.oFeatures.bInfo) {
                    var a = this.s.dt, b = this.dom.scroller.scrollTop, c = Math.floor(this.fnPixelsToRow(b, !1, this.s.ani) + 1), d = a.fnRecordsTotal(), f = a.fnRecordsDisplay(), b = Math.ceil(this.fnPixelsToRow(b + this.s.heights.viewport, !1, this.s.ani)),
                            ...
                            c).replace("_END_", b).replace("_TOTAL_", f) + " " + a.oLanguage.sInfoFiltered.replace("_MAX_", a.fnFormatNumber(a.fnRecordsTotal())) + a.oLanguage.sInfoPostFix, a = a.aanFeatures.i;
    ...
    "function" === typeof define && define.amd ? define("datatables-scroller",
            ["jquery", "datatables"], l) : jQuery && !jQuery.fn.dataTable.Scroller && l(jQuery, jQuery.fn.dataTable)
})(window, document);
